...
public:
	static const GLint vcount = 6; // Кол-во вершин

	// Значения для моделей по умолчанию. Они объявлены в public, т.к. являются константами и их всё равно нельзя изменить
